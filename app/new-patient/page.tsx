          ...
          <div className="split split--50-50 reveal">
            ...
            <div className="form-card">
              ...
              <LeadForm>
                ...
                <div className="form-row"><div className="form-field"><label>Phone</label><input type="tel" name="phone" className="phone-input" placeholder="(830) 255-4350" required /></div><div className="form-field"><label>Email</label><input type="email" name="email" placeholder="you@email.com" required /></div></div>
