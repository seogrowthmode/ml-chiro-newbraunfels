          ...
          <div className="form-section__inner reveal">
            <div>
              ...
              <h2 className="form-section__headline">
                <span className="line1">Your whole family.</span>
                <span className="line2">Covered.</span>
              </h2>
        ...
        <div className="container">
          <div className="empathy__header reveal">
            ...
            <h2 className="empathy__headline">
              <span className="line1">The numbers</span>
              <span className="line2">tell the story.</span>
            </h2>
          </div>
          ...
          <div className="service-healing__inner reveal">
            ...
            <div>
              ...
              <h2 className="service-healing__headline">
                <span className="line1">5 years, U.S. Army.</span>
                <span className="line2">Then he watched her heal.</span>
              </h2>
              ...
              <div key={i} className={`svc-accordion${svc.open ? ' open' : ''}`} data-svc="">
                ...
                <div className="svc-accordion__body">
                  <div className="svc-accordion__body-inner">
                    ...
                    <div className="svc-accordion__image"><div className="svc-accordion__image-placeholder">{svc.imgLabel}</div></div>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="container">
          <div className="essentials__header reveal">
            ...
            <h2 className="essentials__headline">
              <span className="line1">Five essentials.</span>
              <span className="line2">One complete life.</span>
            </h2>
          </div>
          ...
          <div className="results__inner">
            <div className="reveal">
              ...
              <h2 className="results__headline">
                <span className="line1">This is what</span>
                <span className="line2">freedom looks like.</span>
              </h2>
        ...
        <div className="container">
          <div className="testimonials__header reveal">
            ...
            <h2 className="testimonials__headline">
              <span className="line1">67 families.</span>
              <span className="line2">Perfect 5.0.</span>
            </h2>
          </div>
        ...
        <div className="container">
          <div className="process__header reveal">
            ...
            <h2 className="process__headline">
              <span className="line1">Your first visit.</span>
              <span className="line2">Simple.</span>
            </h2>
          </div>
