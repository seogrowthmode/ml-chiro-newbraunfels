        ...
        <div className="container">
          <div className="schedule-form-wrap">
            ...
            <div className="form-card form-card--gold reveal" data-delay="100">
              ...
              <p className="form-card__subtitle">New Patient Special &mdash; $185</p>
              <LeadForm>
                ...
                <div className="form-row"><div className="form-field"><label>Phone</label><input type="tel" name="phone" className="phone-input" placeholder="(830) 255-4350" required /></div><div className="form-field"><label>Email</label><input type="email" name="email" placeholder="jane@email.com" required /></div></div>
                <div className="form-row"><div className="form-field form-field--full"><label>Preferred Doctor</label><select name="doctor"><option value="">No Preference</option><option value="rachel">Dr. Rachel Diestel</option><option value="travis">Dr. Travis Diestel</option></select></div></div>
        ...
        <div className="container">
          <div className="doc-ref reveal">
            <div className="doc-ref__card doc-ref__card--rachel">
              ...
              <p className="doc-ref__focus">Structural Correction &middot; Prenatal &middot; Pediatric &middot; Nutrition &middot; Pre/Peri-Natal Certified</p>
              <p className="doc-ref__desc">Her own health transformation through chiropractic drives her passion for caring for moms, babies, and growing families.</p>
            </div>
            <div className="doc-ref__card doc-ref__card--travis">
              <p className="doc-ref__name">Dr. Travis Diestel D.C.</p>
              <p className="doc-ref__focus">Structural Correction &middot; Prenatal &middot; Pediatric &middot; Corrective Exercise &middot; Level 2 Activator</p>
